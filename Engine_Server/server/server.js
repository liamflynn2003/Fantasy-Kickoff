...
app.post('/simulate', async (req, res) => {
  try {
    ...
    // Track score
    let scoreTimeline = [];
    let lastRecordedScore = { team1Goals: 0, team2Goals: 0 };
    ...
    while (iterationCount < maxIterations) {
      ...
      if (
        currentScore.team1Goals !== lastRecordedScore.team1Goals ||
        currentScore.team2Goals !== lastRecordedScore.team2Goals
      ) {
        scoreTimeline.push({
      ...
      if (iterationCount === 5000 && matchDetails.half === 1) {
